...
public final class GeneratedBioPackager_bad667d8 {
    ...
    private static void storyboard$0(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.modifyBlockEntity(scene, Map.ofEntries(Map.entry("powered", "true"), Map.entry("facing", "north")), "{Active:1b,AnimationInward:1b,AnimationTicks:20,ChainReturnAnimation:1b,ForgeCaps:{},HeldBox:{Count:1b,id:\"create_biotech:empty_cardboard_box\"},InsertedBox:{Count:0b,id:\"minecraft:air\"}}", null, new BlockPos(2, 1, 2), null);
        scene.idle(20);
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "生物打包机会从其附着的库存中提取装有生物的纸箱并释放到其上方", new Vec3(2.5, 1.0, 2.5), 120, null, true);
        GeneratedPonderSupport.showControls(scene, new Vec3(2.5, 2.0, 3.5), "down", 120, null, "create_biotech:empty_cardboard_box", null, false, false);
        scene.idle(130);
    }
    ...
    private static void storyboard$1(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.setBlock(scene, context, "create:mechanical_piston_head", Map.ofEntries(Map.entry("waterlogged", "false"), Map.entry("facing", "south"), Map.entry("type", "sticky")), new BlockPos(2, 1, 1), null, null, false, false, "none", null, null, null, null, null);
        GeneratedPonderSupport.setBlock(scene, context, "create:piston_extension_pole", Map.ofEntries(Map.entry("waterlogged", "false"), Map.entry("facing", "south")), new BlockPos(2, 1, 0), null, null, false, false, "none", null, null, null, null, null);
        scene.idle(20);
        GeneratedPonderSupport.setBlock(scene, context, "create:sticky_mechanical_piston", Map.ofEntries(Map.entry("facing", "south"), Map.entry("state", "extended"), Map.entry("axis_along_first", "true")), new BlockPos(3, 1, 1), null, "{ExtensionLength:1,ForgeCaps:{},Network:{AddedStress:4.0f,Capacity:262144.0f,Id:-3023656943676L,Size:5,Stress:128.0f},Offset:1.0f,Owner:[I;-1968797709,1960923120,-1511276926,529736202],Running:0b,ScrollValue:0,Source:{X:-13,Y:-59,Z:6},Speed:32.0f,Waiting:0b}", true, false, "none", null, null, null, null, null);
        GeneratedPonderSupport.destroyBlock(scene, context, new BlockPos(3, 1, 0), null, false);
        GeneratedPonderSupport.moveSection(scene, context, "default2", new BlockPos(2, 1, 0), null, new Vec3(1.0, 0.0, 0.0), 0);
        GeneratedPonderSupport.moveSection(scene, context, "default3", new BlockPos(2, 1, 1), null, new Vec3(1.0, 0.0, 0.0), 0);
        GeneratedPonderSupport.moveSection(scene, context, "default2", null, null, new Vec3(0.0, 0.0, 1.0), 20);
        GeneratedPonderSupport.moveSection(scene, context, "default3", null, null, new Vec3(0.0, 0.0, 1.0), 20);
        scene.addKeyframe();
        ...
        GeneratedPonderSupport.modifyBlockEntity(scene, Map.ofEntries(Map.entry("powered", "false"), Map.entry("facing", "west")), "{Active:1b,AnimationInward:1b,AnimationTicks:20,ChainReturnAnimation:1b,ForgeCaps:{},HeldBox:{Count:1b,id:\"create_biotech:empty_cardboard_box\"},InsertedBox:{Count:0b,id:\"minecraft:air\"}}", null, new BlockPos(2, 2, 2), null);
        scene.idle(20);
