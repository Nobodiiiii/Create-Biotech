...
public final class GeneratedCreeperBlastChamber_685cd207 {
    ...
    private static void storyboard$0(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "Edit this ponder scene!", new Vec3(3.5, 4.5, 2.0), 60, null, true);
        scene.idle(70);
    ...
    private static void storyboard$2(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.modifyBlockEntity(scene, Map.ofEntries(Map.entry("facing", "north")), "{Finished:0b,ForgeCaps:{},Mode:0,NeedsUpdate:0b,Network:{AddedStress:8.0f,Capacity:1048576.0f,Id:-9620726763576L,Size:16,Stress:4608.0f},Running:1b,Source:{X:-35,Y:-56,Z:-9},Speed:-64.0f,Ticks:32}", null, new BlockPos(3, 4, 3), new BlockPos(5, 4, 5));
        GeneratedPonderSupport.playSound(scene, "minecraft:entity.creeper.primed", 0.6f, 1.0f, "blocks");
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.15f}}}", null, null);
        scene.idle(5);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.3f}}}", null, null);
        scene.idle(5);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.5f}}}", null, null);
        scene.idle(5);
        GeneratedPonderSupport.playSound(scene, "minecraft:entity.creeper.primed", 0.7f, 1.15f, "blocks");
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.7f}}}", null, null);
        scene.idle(5);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.9f}}}", null, null);
        scene.idle(5);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:1.0f}}}", null, null);
        scene.idle(5);
        GeneratedPonderSupport.playSound(scene, "minecraft:entity.generic.explode", 1.0f, 1.15f, "blocks");
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(3.5, 2.5, 3.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(4.5, 2.5, 3.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(5.5, 2.5, 3.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(3.5, 2.5, 4.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion_emitter", new Vec3(4.5, 2.5, 4.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(5.5, 2.5, 4.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(3.5, 2.5, 5.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(4.5, 2.5, 5.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:explosion", new Vec3(5.5, 2.5, 5.5), Vec3.ZERO, 1.0f, 1);
        GeneratedPonderSupport.rotateCameraY(scene, 4.0f, 4.0f, 3);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.7f}}}", null, null);
        GeneratedPonderSupport.rotateCameraY(scene, -8.0f, -8.0f, 3);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.4f}}}", null, null);
        GeneratedPonderSupport.rotateCameraY(scene, 4.0f, 4.0f, 4);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.15f}}}", null, null);
        scene.idle(8);
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ForgeData:{create_biotech:{PonderCompression:0.0f}}}", null, null);
        scene.idle(12);
        GeneratedPonderSupport.rotateCameraY(scene, -35.0f, -35.0f, 10);
        GeneratedPonderSupport.modifyBlockEntity(scene, Map.ofEntries(Map.entry("facing", "north")), "{Finished:1b,ForgeCaps:{},Mode:0,NeedsUpdate:1b,Network:{AddedStress:8.0f,Capacity:1048576.0f,Id:-9620726763576L,Size:16,Stress:4608.0f},Running:1b,Source:{X:-35,Y:-56,Z:-9},Speed:-64.0f,Ticks:240}", null, new BlockPos(3, 4, 3), new BlockPos(5, 4, 5));
