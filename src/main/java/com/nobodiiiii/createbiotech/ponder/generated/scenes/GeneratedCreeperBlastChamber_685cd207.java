...
public final class GeneratedCreeperBlastChamber_685cd207 {
    ...
    private static void storyboard$2(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.startPressCycle(scene, new BlockPos(3, 4, 3), new BlockPos(5, 4, 5), -64.0f);
        GeneratedPonderSupport.startCompressionAnimation(scene, "minecraft:creeper", 0, 64, 1.0f);
        ...
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(3.5, 2.5, 3.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(4.5, 2.5, 3.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(5.5, 2.5, 3.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(3.5, 2.5, 4.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(4.5, 2.5, 4.5), new Vec3(0.0, 0.05, 0.0), 2.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(5.5, 2.5, 4.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(3.5, 2.5, 5.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(4.5, 2.5, 5.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        GeneratedPonderSupport.emitParticles(scene, "minecraft:large_smoke", new Vec3(5.5, 2.5, 5.5), new Vec3(0.0, 0.05, 0.0), 1.0f, 1);
        ...
        GeneratedPonderSupport.rotateCameraY(scene, 4.0f, 4.0f, 2);
        scene.idle(15);
        GeneratedPonderSupport.clearCompressionAnimation(scene, "minecraft:creeper");
        GeneratedPonderSupport.rotateCameraY(scene, -35.0f, -35.0f, 10);
