...
public final class GeneratedCreeperBlastChamber_685cd207 {
    ...
    public static void register(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        ...
        var multi = helper.forComponents(java.util.List.of(ResourceLocation.fromNamespaceAndPath("create_biotech", "creeper_blast_chamber")));
        multi.addStoryBoard(ResourceLocation.fromNamespaceAndPath("create_biotech", "generated/ponderer/creeper_blast_chamber_base_xl"), GeneratedCreeperBlastChamber_685cd207::storyboard$0, tags);
        multi.addStoryBoard(ResourceLocation.fromNamespaceAndPath("create_biotech", "generated/ponderer/creeper_blast_chamber_base_xl"), GeneratedCreeperBlastChamber_685cd207::storyboard$1, tags);
        multi.addStoryBoard(ResourceLocation.fromNamespaceAndPath("create_biotech", "generated/ponderer/creeper_blast_chamber_base_xl"), GeneratedCreeperBlastChamber_685cd207::storyboard$2, tags);
        multi.addStoryBoard(ResourceLocation.fromNamespaceAndPath("create_biotech", "generated/ponderer/creeper_blast_chamber_base_xl"), GeneratedCreeperBlastChamber_685cd207::storyboard$3, tags);
        multi.addStoryBoard(ResourceLocation.fromNamespaceAndPath("create_biotech", "generated/ponderer/creeper_blast_chamber_base_xl"), GeneratedCreeperBlastChamber_685cd207::storyboard$4, tags);
    }

    public static void registerTags(PonderTagRegistrationHelper<ResourceLocation> helper) {
        ResourceLocation tag = GeneratedPonderAttribution.tag();
        helper.addTagToComponent(ResourceLocation.fromNamespaceAndPath("create_biotech", "creeper_blast_chamber"), tag);
    }
    ...
    private static void storyboard$0(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_large.nbt"), new BlockPos(2, 1, 2), 0, false, false, false, "none", null, null, null, null, null);
    ...
    private static void storyboard$1(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_small.nbt"), new BlockPos(4, 1, 2), 0, false, false, false, "simultaneous", 20, 1, true, null, "down");
        scene.addKeyframe();
        ...
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_medium.nbt"), new BlockPos(3, 1, 2), 0, false, false, false, "none", null, null, null, null, null);
    ...
    private static void storyboard$2(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.showStructure(scene, context, null, null, null, null);
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_large.nbt"), new BlockPos(2, 1, 2), 0, false, false, false, "simultaneous", 20, 1, true, null, "down");
        scene.idle(40);
        ...
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_press_array.nbt"), new BlockPos(3, 4, 2), 0, false, true, false, "none", null, null, null, null, null);
    ...
    private static void storyboard$3(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.showStructure(scene, context, null, null, null, null);
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_large.nbt"), new BlockPos(2, 1, 2), 0, false, false, false, "simultaneous", 20, 1, false, null, "down");
        scene.idle(30);
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "苦力怕爆破室最高接受128rpm的转速", new Vec3(4.5, 4.5, 2.0), 120, null, true);
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_128rpm.nbt"), new BlockPos(3, 4, 1), 0, false, true, false, "none", null, null, null, null, null);
        scene.idle(130);
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "超过128rpm的转速会使其进入过载状态", new Vec3(4.0, 4.5, 1.5), 120, "red", true);
        GeneratedPonderSupport.showExtraStructure(scene, context, ResourceLocation.fromNamespaceAndPath("create_biotech", "ponder/generated/ponderer/creeper_blast_chamber_256rpm.nbt"), new BlockPos(3, 4, 1), 0, false, true, false, "none", null, null, null, null, null);
        scene.idle(130);
        scene.addKeyframe();
