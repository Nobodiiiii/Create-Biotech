...
public final class GeneratedExperiencePump_e984f13b {
    ...
    private static void storyboard$0(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "经验储罐...", new Vec3(2.5, 1.5, 3.5), 30, null, true);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:experience_tank", Map.ofEntries(Map.entry("shape", "window"), Map.entry("top", "true"), Map.entry("bottom", "false")), new BlockPos(2, 2, 3), null, "{Controller:{X:-25,Y:-59,Z:-1},ForgeCaps:{},LastKnownPos:{X:-25,Y:-58,Z:-1},Luminosity:0}", false, false, "none", null, null, null, null, null);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:experience_tank", Map.ofEntries(Map.entry("shape", "window"), Map.entry("top", "false"), Map.entry("bottom", "true")), new BlockPos(2, 1, 3), null, "{ForgeCaps:{},Height:2,LastKnownPos:{X:-25,Y:-59,Z:-1},Luminosity:0,StoredExperience:6000,Width:1,Window:1b}", false, false, "none", null, null, null, null, null);
    ...
    private static void storyboard$1(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:experience_tank", Map.ofEntries(Map.entry("shape", "window"), Map.entry("top", "true"), Map.entry("bottom", "false")), new BlockPos(2, 2, 3), null, "{Controller:{X:-25,Y:-59,Z:-1},ForgeCaps:{},LastKnownPos:{X:-25,Y:-58,Z:-1},Luminosity:0}", false, false, "simultaneous", 20, 1, false, null, "down");
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:experience_tank", Map.ofEntries(Map.entry("shape", "window"), Map.entry("top", "false"), Map.entry("bottom", "true")), new BlockPos(2, 1, 3), null, "{ForgeCaps:{},Height:2,LastKnownPos:{X:-25,Y:-59,Z:-1},Luminosity:0,StoredExperience:6000,Width:1,Window:1b}", false, false, "simultaneous", 20, 1, false, null, "down");
        scene.addKeyframe();
        ...
        GeneratedPonderSupport.clearEntities(scene, true, null, null, null);
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "也可以输出到经验储罐，或其他接受经验的容器", new Vec3(2.5, 1.0, 1.5), 120, null, true);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:experience_tank", Map.ofEntries(Map.entry("shape", "window"), Map.entry("top", "true"), Map.entry("bottom", "true")), new BlockPos(2, 1, 1), null, "{ForgeCaps:{},Height:1,LastKnownPos:{X:-39,Y:-59,Z:6},Luminosity:0,StoredExperience:0,Width:1,Window:1b}", false, false, "simultaneous", 20, 1, false, null, "down");
        scene.idle(60);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:evoker_enchanting_chamber", Map.ofEntries(Map.entry("half", "lower"), Map.entry("facing", "north")), new BlockPos(2, 1, 1), null, "{ForgeCaps:{},HeldItem:{Count:1b,id:\"create_biotech:enchantment_book_copy\",tag:{StoredEnchantments:[{id:\"minecraft:protection\",lvl:4s}]}},StoredExperience:0,WaitingForExperience:1b,XpRemaining:414,XpTotal:4000}", false, false, "simultaneous", 20, 1, false, null, "down");
        scene.idle(70);
