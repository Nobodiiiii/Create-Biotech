...
public class CBItems {
	...
	public static final RegistryObject<Item> EMPTY_MAGMA_CUBE_BURNER =
		ITEMS.register("empty_magma_cube_burner",
			() -> MagmaCubeBurnerItem.empty(CBBlocks.MAGMA_CUBE_BURNER.get(), new Item.Properties()));

	public static final RegistryObject<Item> MAGMA_CUBE_BURNER = ITEMS.register("magma_cube_burner",
	...
	public static final RegistryObject<Item> DING_DONG_CHICKEN_SPAWN_EGG =
		ITEMS.register("ding_dong_chicken_spawn_egg",
			() -> new ForgeSpawnEggItem(CBEntityTypes.DING_DONG_CHICKEN, 0xA1A1A1, 0xD8A52A,
				new Item.Properties()));

	public static final RegistryObject<Item> DING_DONG_CHICKEN = ITEMS.register("ding_dong_chicken",
