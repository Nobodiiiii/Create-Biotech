...
public class CBBlockEntityTypes {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<NetherPortalFluidBlockEntity>> NETHER_PORTAL_FLUID =
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<GhastHotAirBalloonAssemblyStationBlockEntity>> GHAST_HOT_AIR_BALLOON_ASSEMBLY_STATION =
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FrogDigestiveTractBlockEntity>>
		FROG_DIGESTIVE_TRACT = BLOCK_ENTITY_TYPES.register("frog_digestive_tract",
			() -> BlockEntityType.Builder
